...
function checkPopulation() {
  document.getElementById("section-2").style.backgroundColor = "aliceblue";
  ...
  let percent = (worldPopulation / worldPopulation) * 100;
  tbodyRef.innerHTML += `
		<tr>
		<td>World</td>
		<td class="middletd"><div class="tablediv" style='width:${percent}%'></div></td>
		<td>7693165599</td>
		</tr>
		`;
  for (let i = 0; i < 10; i++) {
...
function checkLanguage() {
  ...
  for (let i = 0; i < 10; i++) {
    tbodyRef.innerHTML += `
		<tr>
		<td>${sortable[i][0]}</td>
		<td class="middletd"><div class='tablediv' style='width:${sortable[i][1]}%'></div></td>
		<td>${sortable[i][1]}</td>
		</tr>
		`;
  }
